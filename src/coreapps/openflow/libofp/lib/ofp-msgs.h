...
/*#ifdef VGW_JINDYLIU*/
/* Tencent extension messages */
    /* TENXT 1.0+ (0): struct tenxt_gw_fdb[]. */
    OFPRAW_TENXT_GW_FDBS_CFG,
    
    /* TENXT 1.0+ (1): struct ofp_tencent_gw_fdb_rep. */
    OFPRAW_TENXT_GW_FDBS_REP,
...
/*#ifdef VGW_JINDYLIU*/
    /* Tencent extensions. */
    OFPTYPE_TENXT_GW_FDBS_CFG,      /* OFPRAW_TENXT_GW_FDBS_CFG. */
    OFPTYPE_TENXT_GW_FDBS_REP,      /* OFPRAW_TENXT_GW_FDBS_REP. */  
/*#endif*/ /* VGW_JINDYLIU */
